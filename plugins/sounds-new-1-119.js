...
ptt: false, seconds: 0,contextInfo: {
 ...
 mediaUrl: 'www.instagram.com/raffuri',
    mediaType: 2, 
    description: 'www.instagram.com/raffuri',
    title: "Now Playing...",
    body: wm,
    thumbnail: await (await fetch('https://i.ibb.co/JqKtP5s/20220902-203305-11zon.jpg')).buffer(),
    sourceUrl: 'www.instagram.com/raffuri'
 	  }
     }
    })
}
