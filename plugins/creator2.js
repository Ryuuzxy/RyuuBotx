...
if (command == 'whmods1') {
 let vcard = `BEGIN:VCARD\nVERSION:3.0\nN:WhatsApp;Saya Owner Ryuu;Bot;;Md\nFN:Saya Owner RyuuBot WhatsApp, Md\nNICKNAME:👑 Owner RyuuBot\nORG:Raffuri\nTITLE:Desu\nitem1.TEL;waid=6281291155341:+62 812-9115-5341\nitem1.X-ABLabel:📞 Nomor Owner\nitem2.URL:https://youtube.com/channel/UCBYk6B1tkZ233ElCqImkC7Q\nitem2.X-ABLabel:💬 More\nitem3.EMAIL;type=INTERNET:wakay4ma@gmail.com\nitem3.X-ABLabel:💌 Mail Owner RyuuBot\nitem4.ADR:;;🇮🇩 Indonesia;;;;\nitem4.X-ABADR:💬 More\nitem4.X-ABLabel:📍 Lokasi Saya\nBDAY;value=date:🔖 KEPO LU YAH\nEND:VCARD`
...
if (command == 'whmods2') {
  let vcard = `BEGIN:VCARD\nVERSION:3.0\nN:;${author};;;\nFN:${author}\nORG:${author}\nTITLE:\nitem1.TEL;waid=6281291155351:+62 812-9115-5341\nitem1.X-ABLabel:${author}\nX-WA-BIZ-DESCRIPTION:${htjava} Nih pengembang ku kack yg mengaktifkan aq.\nX-WA-BIZ-NAME:${author}\nEND:VCARD`
await conn.sendMessage(m.chat, { contacts: { displayName: wm, contacts: [{ vcard }] }}, { quoted: fakes })
}
if (command == 'whmods3') {
  try {
  const sentMsg = await conn.sendContactArray(m.chat, [
    [`${nomorown}`, `${await conn.getName(nomorown+'@s.whatsapp.net')}`, `👑 Developer Bot `, `🚫 Don't call me 🥺`, `wakay4ma@gmail.com`, `🇮🇩 Indonesia`, `🚀 https://youtube.com/channel/UCBYk6B1tkZ233ElCqImkC7Q`, `👤 Tada no yowai otoko 😔`],
    [`${conn.user.jid.split('@')[0]}`, `${await conn.getName(conn.user.jid)}`, `🔥 Bot WhatsApp 🐣`, `📵 Don't spam/call me 😢`, `Nothing`, `🇮🇩 Indonesia`, `🚀 https://github.com/Ryuufuri/`, `🤖 Hanya bot biasa yang kadang suka eror ☺`]
  ], fakes)
